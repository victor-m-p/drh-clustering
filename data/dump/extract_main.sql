SELECT DISTINCT 
    p1.poll, b1.question_id, q1.question_name, q2.parent_question_id, q2.parent_question, b1.entry_id, en2.entry_name, en3.data_source, en1.entry_description,
    ...
    b1.region_id, b1.date_created, b1.date_modified, e1.expert_id, e2.expert_name, e1.editor_id, COALESCE(e3.regionaleditor_name, e4.managingeditor_name) AS editor_name,
    a3.date_published, a3.published
FROM  
...
WHERE a3.published is true AND p1.poll != 'Polity'
GROUP BY p1.poll, b1.question_id, q1.question_name, q2.parent_question_id, q2.parent_question, b1.entry_id, b1.region_id, b1.date_modified, b1.date_created, en2.entry_name, en3.data_source, en1.entry_description, a1.text_input, a1.name, a1.value, b1.notes, b1.year_from, b1.year_to, e2.expert_name, e1.expert_id, e1.editor_id, editor_name, a3.published, a3.date_published, b3.parent_name, b3.parent_text_input, b3.parent_answer_value, br3.branching_question_name 
ORDER BY b1.entry_id DESC;